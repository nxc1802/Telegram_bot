...
bot_token = "7580021843:AAH2upfyhnkgmwp6EoH4C0hDCN--dOiXROI"
...
# Hàm thiết lập webhook cho Telegram
def set_webhook():
    space_url = "https://telegrambot.hf.space/webhook"
    r = requests.get(f"https://api.telegram.org/bot{bot_token}/setWebhook?url={space_url}")
    logger.info("Set webhook: %s", r.text)

if __name__ == '__main__':
    set_webhook()
    # Chạy Flask app để lắng nghe webhook từ Telegram
